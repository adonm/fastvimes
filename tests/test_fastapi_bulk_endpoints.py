...
class TestFastAPIBulkEndpoints:
    ...
    def create_parquet_file_content(self, data: List[Dict[str, Any]]) -> bytes:
        ...
        conn.execute("CREATE TABLE temp_table AS SELECT * FROM (VALUES " + 
                    ",".join([f"({','.join([repr(v) for v in row.values()])})" for row in data]) + 
    ...
    def test_bulk_insert_json_file(self, test_client, test_db_service):
        ...
        test_data = [
            {"id": 200, "name": "API User 1", "email": "api1@example.com", "age": 25, "active": True, "department": "API", "created_at": "2024-01-01 12:00:00"},
            {"id": 201, "name": "API User 2", "email": "api2@example.com", "age": 30, "active": True, "department": "API", "created_at": "2024-01-01 13:00:00"}
        ]
    ...
    def test_bulk_insert_csv_file(self, test_client, test_db_service):
        ...
        # Create test data with unique emails
        test_data = [
            {"id": 202, "name": "API CSV User 1", "email": "api-csv1@example.com", "age": 28, "active": True, "department": "CSV", "created_at": "2024-01-01 14:00:00"},
            {"id": 203, "name": "API CSV User 2", "email": "api-csv2@example.com", "age": 32, "active": True, "department": "CSV", "created_at": "2024-01-01 15:00:00"}
        ]
    ...
    def test_bulk_insert_parquet_file(self, test_client, test_db_service):
        ...
        # Create test data with unique emails
        test_data = [
            {"id": 204, "name": "API Parquet User 1", "email": "api-parquet1@example.com", "age": 26, "active": True, "department": "Parquet", "created_at": "2024-01-01 16:00:00"},
            {"id": 205, "name": "API Parquet User 2", "email": "api-parquet2@example.com", "age": 29, "active": True, "department": "Parquet", "created_at": "2024-01-01 17:00:00"}
        ]
        ...
        response = test_client.post(
            "/v1/data/users/bulk-insert",
            files={"file": ("test_data.parquet", file_content, "application/octet-stream")},
    ...
    def test_bulk_insert_auto_format_detection(self, test_client, test_db_service):
        ...
        # Create test data with unique emails
        test_data = [
            {"id": 206, "name": "API Auto User 1", "email": "api-auto1@example.com", "age": 27, "active": True, "department": "Auto", "created_at": "2024-01-01 18:00:00"},
            {"id": 207, "name": "API Auto User 2", "email": "api-auto2@example.com", "age": 31, "active": True, "department": "Auto", "created_at": "2024-01-01 19:00:00"}
        ]
    ...
    def test_bulk_upsert_json_file(self, test_client, test_db_service):
        ...
        test_data = [
            {"id": 901, "name": "Updated API User 1", "email": "updated-api1@example.com", "age": 99, "active": False, "department": "Updated", "created_at": "2024-01-01 20:00:00"},
            {"id": 902, "name": "New API User", "email": "new-api@example.com", "age": 35, "active": True, "department": "New", "created_at": "2024-01-01 21:00:00"}
        ]
    ...
    def test_bulk_upsert_csv_file(self, test_client, test_db_service):
        ...
        test_data = [
            {"id": 903, "name": "Updated API User 2", "email": "updated-api2@example.com", "age": 88, "active": False, "department": "Updated2", "created_at": "2024-01-01 22:00:00"},
            {"id": 904, "name": "Another New API User", "email": "another-api@example.com", "age": 40, "active": True, "department": "Another", "created_at": "2024-01-01 23:00:00"}
        ]
    ...
    def test_bulk_upsert_multiple_key_columns(self, test_client, test_db_service):
        ...
        test_data = [
            {"id": 208, "name": "Multi Key API User", "email": "multi-api@example.com", "age": 33, "active": True, "department": "Multi", "created_at": "2024-01-02 00:00:00"}
        ]
    ...
    def test_bulk_delete_json_file(self, test_client, test_db_service):
        ...
        insert_data = [
            {"id": 300, "name": "API Delete User 1", "email": "api-delete1@example.com", "age": 25, "active": True, "department": "Delete", "created_at": "2024-01-02 01:00:00"},
            {"id": 301, "name": "API Delete User 2", "email": "api-delete2@example.com", "age": 30, "active": True, "department": "Delete", "created_at": "2024-01-02 02:00:00"}
        ]
    ...
    def test_bulk_delete_csv_file(self, test_client, test_db_service):
        ...
        # First, insert records to delete
        insert_data = [
            {"id": 302, "name": "API Delete CSV User 1", "email": "api-delete-csv1@example.com", "age": 28, "active": True, "department": "DeleteCSV", "created_at": "2024-01-02 03:00:00"},
            {"id": 303, "name": "API Delete CSV User 2", "email": "api-delete-csv2@example.com", "age": 32, "active": True, "department": "DeleteCSV", "created_at": "2024-01-02 04:00:00"}
        ]
...
class TestFastAPIBulkEndpointsMultiSchema:
    ...
    def test_bulk_operations_with_custom_schema(self, test_client, test_db_service):
        ...
        test_data = [
            {"custom_id": 4, "custom_name": "API New Item 1", "custom_value": 150.5, "custom_flag": True},
            {"custom_id": 5, "custom_name": "API New Item 2", "custom_value": 250.7, "custom_flag": False}
        ]
        ...
        upsert_data = [
            {"custom_id": 1, "custom_name": "Updated API Item 1", "custom_value": 999.9, "custom_flag": False}
        ]
